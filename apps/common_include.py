...
MNIST_path = os.path.join(parent_path,"MNIST")
if MNIST_path not in sys.path: sys.path.append(MNIST_path)
...
reverse_path = os.path.join(parent_path,"reverse")
if reverse_path not in sys.path: sys.path.append(reverse_path)
radon_path = os.path.join(parent_path,"radon")
if radon_path not in sys.path: sys.path.append(radon_path)
time_series_path = os.path.join(parent_path,"Time series")
